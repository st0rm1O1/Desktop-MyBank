...
public class Account extends JPanel {
	...
	private JPanel btn_icon, line_1, line_2, line_3, change_btn_icon;
	private JLabel back_btn, username_label, mail_label, dob_label, contact_label, gender_label, bal_label, password_label, username_txt, mail_txt, dob_txt, contact_txt, gender_txt, bal_txt, change_btn_1, change_btn_2;
	private JLabel delete_btn;
	private JPanel delete_icon;
...
//		setUI(new ImageRender("/MESH/gradient_"+ new Random().nextInt(12) + ".png"));
		...
		back_btn.setFont(res.getInter(2, 24));
		...
		delete_btn.setFont(res.getInter(2, 24));
		...
		delete_icon.setUI(new ImageRender(res.getNEXT_R_PATH()));
		...
		username_label.setFont(res.getInter(2, 18));
		mail_label.setFont(res.getInter(2, 18));
		dob_label.setFont(res.getInter(2, 18));
		contact_label.setFont(res.getInter(2, 18));
		gender_label.setFont(res.getInter(2, 18));
		bal_label.setFont(res.getInter(2, 18));
		password_label.setFont(res.getInter(2, 18));
		...
		username_txt.setFont(res.getInter(3, 27));
		mail_txt.setFont(res.getInter(3, 27));
		dob_txt.setFont(res.getInter(3, 27));
		contact_txt.setFont(res.getInter(3, 27));
		gender_txt.setFont(res.getInter(3, 27));
		bal_txt.setFont(res.getInter(3, 27));
		...
		change_btn_1.setFont(res.getInter(2, 24));
		change_btn_2.setFont(res.getInter(2, 24));
		...
		change_btn_icon.setUI(new ImageRender(res.getNEXT_B_PATH()));
