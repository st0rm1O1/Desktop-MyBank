...
public class Login extends JPanel {
	...
	private final JTextField public_key;
	private final JPasswordField private_key;
	private final JButton btn;
	private final JTextArea public_util, private_util;
	private final JPanel img_panel, btn_icon;
	private final JLabel register_txt, register_action, back_btn;
	private final DAO db;
	private final String public_hint = "email address or username";
	private final String private_hint = "password";
	

	public Login(LayerPanel layerPanel) {
...
//		setUI(new ImageRender("/MESH/gradient_"+ new Random().nextInt(12) + ".png"));
		...
		img_panel.setUI(Resource.renderImage(Resource.ICON_PATH_AVATAR));
		...
		public_key.setFont(Resource.getInterRegular(20));
		...
		private_key.setFont(Resource.getInterRegular(20));
		...
		btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String user_data = public_key.getText();
		...
		public_util.setFont(Resource.getInterRegular(16));
		...
		private_util.setFont(Resource.getInterRegular(16));
