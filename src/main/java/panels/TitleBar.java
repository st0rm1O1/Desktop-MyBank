...
public class TitleBar extends JPanel {
	...
	private final JPanel view, close, min, max;
	...
	public TitleBar(final JFrame f) {
		...
		UIManager.put("ToolTip.border", new CompoundBorder(BorderFactory.createLineBorder(new Color(38, 50, 56), 1),
	...
	private void initialize(final JFrame f) {
		...
		title.setFont(Resource.getInterSemibold(20));
